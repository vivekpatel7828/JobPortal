...
const Footer = () => {
  return (
    <motion.footer
      className="border-t border-gray-200 py-10 bg-white"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-sm text-gray-600">© 2024 Job Hunt Inc. All rights reserved.</p>
          </div>

          {/* Navigation (optional future links) */}
          {/* <ul className="flex space-x-6 text-sm text-gray-600">
            <li><a href="/privacy" className="hover:text-[#6A38C2] transition">Privacy</a></li>
            <li><a href="/terms" className="hover:text-[#6A38C2] transition">Terms</a></li>
          </ul> */}

          {/* Social Icons */}
          <div className="flex space-x-5">
            {[
              { href: "https://facebook.com", label: "Facebook", iconPath: "M22.676 0H1.324C..." },
              { href: "https://twitter.com", label: "Twitter", iconPath: "M24 4.557a9.835 9.835..." },
              { href: "https://linkedin.com", label: "LinkedIn", iconPath: "M20.447 20.452H16.85..." }
            ].map(({ href, label, iconPath }, index) => (
              <a
                key={index}
                href={href}
                target="_blank"
